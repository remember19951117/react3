  ...
  render(){
    ...
    return (
      <div className={styles.App}>
        ...
        <div className={styles.main} style={{'padding':'.1rem .5rem .5rem'}}>
            <h3>用户注册协议</h3>
            <h2>一、总则</h2>
            <p>1.1 西安市钱库商贸有限公司的所有权和运营权归西安市钱库商贸有限公司所有。</p>
            <p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与西安市钱库商贸有限公司之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。 </p>
            <p>1.3 本协议则可由西安市钱库商贸有限公司随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。</p>
            <h2>二、服务内容</h2>
            <p>2.1 西安市钱库商贸有限公司的具体内容由本站根据实际情况提供。 </p>
            <p>2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>
            <h2>三、用户帐号</h2>
            <p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分用户权限。西安市钱库商贸有限公司有权对用户的权限设计进行变更。</p>
            ...
            <p>4.2 用户对其自行发表、上传或传送的内容负全部责任，所有用户不得在本站任何页面发布、转载、传送含有下列内容之一的信息，否则本站有权自行处理并不通知用户：<span>(1)违反宪法确定的基本原则的； </span><span>(2)危害国家安全，泄漏国家机密，颠覆国家政权，破坏国家统一的； </span><span>(3)损害国家荣誉和利益的； </span><span>(4)煽动民族仇恨、民族歧视，破坏民族团结的； </span><span>(5)破坏国家宗教政策，宣扬邪教和封建迷信的； </span><span>(6)散布谣言，扰乱社会秩序，破坏社会稳定的；</span><span>(7)散布淫秽、色情、赌博、暴力、恐怖或者教唆犯罪的； </span><span>(8)侮辱或者诽谤他人，侵害他人合法权益的； </span><span>(9)煽动非法集会、结社、游行、示威、聚众扰乱社会秩序的； </span><span>(10)以非法民间组织名义活动的；</span><span>(11)含有法律、行政法规禁止的其他内容的。</span></p>
            ...
            <p>4.4 当第三方认为用户发表或者上传于本站的信息侵犯其权利，并根据《信息网络传播权保护条例》或者相关法律规定向本站发送权利通知书时，用户同意本站可以自行判断决定删除涉嫌侵权信息，除非用户提交书面证据材料排除侵权的可能性，本站将不会自动恢复上述删除的信息；<span>(1)不得为任何非法目的而使用网络服务系统；</span><span>(2)遵守所有与网络服务有关的网络协议、规定和程序；</span><span>(3)不得利用本站进行任何可能对互联网的正常运转造成不利影响的行为；</span><span>(4)不得利用本站进行任何不利于本站的行为。</span></p>
            <p>4.5 如用户在使用网络服务时违反上述任何规定，本站有权要求用户改正或直接采取一切必要的措施(包括但不限于删除用户张贴的内容、暂停或终止用户使用网络服务的权利)以减轻用户不当行为而造成的影响。</p>
            <h2>五、隐私保护</h2>
            <p>5.1 本站不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本站的非公开内容，但下列情况除外：<span>(1)事先获得用户的明确授权；</span><span>(2)根据有关的法律法规要求；</span><span>(3)按照相关政府主管部门的要求；</span><span>(4)为维护社会公众的利益。</span></p>
            ...
            <p>6.3 使用本站的任何内容均应注明“来源于西安市钱库商贸有限公司”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
            ...
            <h2>七、责任声明</h2>
            <p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，西安市钱库商贸有限公司对此不承担任何责任。</p>
            ...
            <p>7.5 对于站向用户提供的下列产品或者服务的质量缺陷本身及其引发的任何损失，本站无需承担任何责任：<span>(1)本站向用户免费提供的各项网络服务； </span><span>(2)本站向用户赠送的任何产品或者服务。</span></p>
            ...
            <p>8.3 本协议解释权及修订权归西安市钱库商贸有限公司所有。</p>
        </div>
      </div>
    )
